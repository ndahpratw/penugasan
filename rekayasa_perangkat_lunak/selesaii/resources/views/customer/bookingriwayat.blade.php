...
<head>
    ...
    <title>Keisuke's Boarding Hotel - Riwayat Pesanan</title>
            ...
            <div class="col-lg-9 ms-auto p-3">
                ...
                <div class="col-lg-12 col-md-12 px-4">
                    ...
                    <div class="card mb-4 border-0 shadow">
                        ...
                        <div class="row g-0 p-3 align-items-center">
                            ...
                            <div class="col-md-4 px-lg-3 px-md-3 px-0">
                                ...
                                <div class="guests">
                                    ...
                                    <span class="badge rounded-pill text-dark text-wrap lh-base"> {{ $bk->pesan }} </span>
                                </div>
                                <div class="mb-1">
                        ...
                        <a href="/testimonial/{{ $bk->id }}" type="button" class="btn btn-outline-dark mb-3 shadow-none" style="width: 150px; margin-right:auto; margin-left:auto;"> Testimoni </a>
