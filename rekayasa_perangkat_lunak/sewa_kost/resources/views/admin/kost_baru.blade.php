            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                @endif
                 ...
                 <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <form action="/kostNew" id="rooms-setting" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('pemilik_id') is-invalid @enderror" aria-label="Default select example" name="pemilik_id">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="tersedia" class="form-control shadow-none" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Penghuni (max)</label>
                                        <input type="number" min="0" name="penghuni" class="form-control shadow-none" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Harga (hari)</label>
                                        <input type="number" min="0" name="harga" class="form-control shadow-none" required>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="lokasi" class="form-control shadow-none" required>
