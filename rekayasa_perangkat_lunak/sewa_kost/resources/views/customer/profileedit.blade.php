                    ...
                    <div class="card-body">
                        <div class="col-lg-7 mb-4 px-lg-2" style="margin-right:auto; margin-left: auto">
                            <div class="card mb-4 border-2 shadow">
                                ...
                                <div class="row g-0 p-5 align-items-center">
                                    <div class="">
                                        <form action="/updateprofil/{{ $user->id }}" id="rooms-setting" method="post">
                                            @method('put')
                                            @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="text" name="username" class="form-control shadow-none" value="{{ $user->username }}">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="text" name="telepon" class="form-control shadow-none" value="{{ $user->telepon }}">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label fw-bold"> Alamat </label>
                                                            <input type="text" name="alamat" class="form-control shadow-none" value="{{ $user->alamat }}">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label fw-bold"> Tanggal Lahir </label>
                                                            <input type="date" name="tanggal_lahir" class="form-control shadow-none" value="{{ $user->tanggal_lahir }}">
                                                        </div>
                                                    </div>
                                                </div>
